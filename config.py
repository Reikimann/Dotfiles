...
mod = "mod4"
terminal = "kitty"
wallpaper = "feh --randomize --bg-fill '/home/cbirkmand/pix/Wallpapers'"
config_file = "/home/cbirkmand/.config/qtile/config.py"
gaps = 7
logo = "/home/cbirkmand/pix/Logo/python-white.png"
...
keys = [ 
    # Edit config
    Key([mod, "shift"], "e", lazy.spawn("kitty -e nvim /home/cbirkmand/.config/qtile/config.py"), desc="Edit config file"),
...
screens = [
    Screen(
        top=bar.Bar(
            [
                widget.TextBox(text = '', padding = 0, fontsize = 30),
                #widget.Systray(),
                widget.TextBox(text = '', padding = 0, fontsize = 30),
                #widget.Image(
                #   filename=logo,
