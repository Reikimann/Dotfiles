...
groups.append(ScratchPad("scratchpad", [
    ...
    DropDown("lf", "kitty -e lf", width=0.6, height=0.7, x=0.2, y=0.15, opacity=0.8),
...
keys.extend([
    ...
    Key([mod, "control"], "2", lazy.group["scratchpad"].dropdown_toggle("lf")),
    Key([mod, "control"], "3", lazy.group["scratchpad"].dropdown_toggle("browser")),
    Key([mod, "control"], "4", lazy.group["scratchpad"].dropdown_toggle("music")),
    ])
