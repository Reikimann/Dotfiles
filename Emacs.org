...
#+begin_src emacs-lisp
  ...
  (setq fast-but-imprecise-scrolling nil) ; Set to t to enable
...
#+begin_src emacs-lisp
  ...
  (use-package doom-modeline
    ...
    (setq doom-modeline-buffer-file-name-style 'file-name ;; Just show file name (no path)
          ...
          doom-modeline-buffer-encoding nil ;; Whether display the buffer encoding.
...
** Dired
#+begin_src emacs-lisp
  (setq dired-kill-when-opening-new-dired-buffer nil) ;; Pretty self-explanatory
#+end_src
